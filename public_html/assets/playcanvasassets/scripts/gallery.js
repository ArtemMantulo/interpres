...
// 📦 Подключаем файл с URL-строками (TXT или CSV)
Gallery.attributes.add('galleryTextAsset', {
    type: 'asset',
    assetType: 'binary',
    title: 'Gallery Image List (.txt or .csv)'
});

Gallery.prototype.initialize = function () {
    console.log('[Gallery] Waiting for DOM...');
