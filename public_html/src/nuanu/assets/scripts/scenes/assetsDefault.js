export function registerAssets(app) {
  ...
  const assetMap = {
    ...
    Floor:       new pc.Asset("Floor", "container", { url: "assets/models/Floor.glb" }),
    ...
    Slide:      new pc.Asset("Slide", "container", { url: "assets/anims/Slide.glb" }),
    Run:        new pc.Asset("Run", "container", { url: "assets/anims/Run.glb" }),
  ...
  const assetList = [
    { asset: assetMap.GSplat,             size: 10.5 * 1024 * 1024 },
    { asset: assetMap.Woman,              size: 2.98 * 1024 * 1024 },
    { asset: assetMap.Coin,               size: 44 * 1024 },
    { asset: assetMap.Floor,              size: 44 * 1024 },
    ...
    { asset: assetMap.Slide,              size: 18 * 1024 },
    { asset: assetMap.Run,                size: 18 * 1024 },
    ...
    { asset: scriptAssets[3],           size: 2 * 1024 },
    { asset: scriptAssets[4],           size: 2 * 1024 },
    { asset: scriptAssets[5],           size: 4 * 1024 },
    { asset: scriptAssets[6],           size: 5 * 1024 },
    { asset: scriptAssets[7],           size: 1024 },
    { asset: scriptAssets[8],           size: 2 * 1024 }
  ];
