...
// Main config
OrbitCamera.attributes.add('portraitDistance', { type: 'number', default: 6 });
OrbitCamera.attributes.add('portraitMinDistance', { type: 'number', default: 4.5 });
OrbitCamera.attributes.add('portraitMaxDistance', { type: 'number', default: 8 });

OrbitCamera.attributes.add('landscapeDistance', { type: 'number', default: 5 });
OrbitCamera.attributes.add('landscapeMinDistance', { type: 'number', default: 3.5 });
OrbitCamera.attributes.add('landscapeMaxDistance', { type: 'number', default: 7 });

OrbitCamera.attributes.add('amenitiesLandscapeDistance', { type: 'number', default: 2 });
OrbitCamera.attributes.add('amenitiesLandscapeMinDistance', { type: 'number', default: 2 });
OrbitCamera.attributes.add('amenitiesLandscapeMaxDistance', { type: 'number', default: 7 });

OrbitCamera.attributes.add('amenitiesPortraitDistance', { type: 'number', default: 3 });
OrbitCamera.attributes.add('amenitiesPortraitMinDistance', { type: 'number', default: 3 });
OrbitCamera.attributes.add('amenitiesPortraitMaxDistance', { type: 'number', default: 8 });
...
OrbitCamera.prototype.onTouchMove = function (e) {
    ...
    if (e.touches.length === 2) {
        ...
        this.distanceTarget += delta * this.zoomSpeed * this.touchZoomSensitivity;
        this.distanceTarget = pc.math.clamp(this.distanceTarget, this.minDistance, this.maxDistance);
