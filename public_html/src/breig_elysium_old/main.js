...
const assetMap = {
    ...
    amenitiesCurrent: new pc.Asset("dataAmenitiesCurrent.csv", "text", { url: "assets/data/dataAmenitiesCurrent.csv" }),
    amenitiesFuture: new pc.Asset("dataAmenitiesFuture.csv", "text", { url: "assets/data/dataAmenitiesFuture.csv" }),
    css: new pc.Asset("asset.css", "css", { url: "assets/web/asset.css" }),
    currentPly: new pc.Asset("current.ply", "gsplat", { url: "assets/gs/Current_7april.compressed.ply" }),
    futurePly: new pc.Asset("future.ply", "gsplat", { url: "assets/gs/Future_7april1.compressed.ply" })
};

const scriptAssets = [
    new pc.Asset("orbit-camera.js", "script", { url: "assets/scripts/orbit-camera.js" }),
    new pc.Asset("mouse-input.js", "script", { url: "assets/scripts/mouse-input.js" }),
    new pc.Asset("touch-input.js", "script", { url: "assets/scripts/touch-input.js" }),
    new pc.Asset("modeSwitcher.js", "script", { url: "assets/scripts/modeSwitcher.js" }),
    ...
    new pc.Asset("uiLoader.js", "script", { url: "assets/scripts/uiLoader.js" }),
