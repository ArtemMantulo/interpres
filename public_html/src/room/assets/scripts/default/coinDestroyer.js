...
CoinDestroyer.attributes.add('spinSpeed', {
    type: 'number', default: 180, title: 'Spin Speed (deg/sec)'
});

CoinDestroyer.attributes.add('floatAmplitude', {
    type: 'number', default: 0.2, title: 'Float Amplitude'
});
CoinDestroyer.attributes.add('floatSpeed', {
    type: 'number', default: 0.5, title: 'Float Speed'
});

CoinDestroyer.attributes.add('flyUpDistance', {
    type: 'number', default: 5, title: 'Fly Up Distance'
});
CoinDestroyer.attributes.add('flyUpDuration', {
    type: 'number', default: 0.6, title: 'Fly Up Duration (sec)'
});

CoinDestroyer.attributes.add('pickupRadius', {
    type: 'number', default: 0.2, title: 'Pickup Radius (m)'
});
CoinDestroyer.attributes.add('horizontalOnly', {
    type: 'boolean', default: true, title: 'Ignore Y (flat distance)'
});
